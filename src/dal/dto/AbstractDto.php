...
abstract class AbstractDto
{
    ...
    {
        if ($this->ngs_mapArray) {
            return $this->ngs_mapArray;
        }
        $this->ngs_mapArray = $this->getMapArray();
        if (!$this->ngs_mapArray) {
            $this->ngs_mapArray = $this->getNgsPropertyAnnotationsByName('orm', true);
            if ($this->ngs_mapArray) {
                $this->ngs_mapArray = array_flip($this->ngs_mapArray);
            }
        }
        return $this->ngs_mapArray;
    }
     ...
     * @return array
     */
    public function toArray(bool $toAssoc = false): array
    {
        $resultArr = [];
        try {
